...
public class Main implements Menu {
    ...
    public static final AdminMenuDeleteCustomerButton ADM_DELETE_CUSTOMER_BUTTON = new AdminMenuDeleteCustomerButton();
    ...
    static {
        ...
        ADMIN_MENU_BUTTONS.add(ADM_DELETE_CUSTOMER_BUTTON);
